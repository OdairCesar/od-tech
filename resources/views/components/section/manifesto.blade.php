<section class="bg-slate-800 px-5 py-16 text-center text-white sm:px-8 sm:py-[120px] min-[960px]:px-14">
    <div data-reveal class="mx-auto max-w-[760px]">
        ...
        <p class="mb-10 text-[17px] leading-relaxed text-white/65">
            Inovar não significa fazer mais. Significa fazer o que realmente importa.
        </p>
        <div class="animate-gradient-shift inline-block bg-[length:200%_auto] bg-gradient-to-r from-blue-400 via-emerald-300 to-blue-400 bg-clip-text text-base font-extrabold text-transparent">
            Ideias que evoluem para soluções.
        </div>
    </div>
</section>
